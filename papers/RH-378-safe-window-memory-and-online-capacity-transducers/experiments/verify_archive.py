"""Verify every RH-378 manifest hash and fixed membership count."""
...
from experiments.build_archive import LOCAL_MEMBERS, SOURCE_FILES  # noqa: E402
...
def main() -> None:
    ...
    if manifest.get("status") != "RH-378_fixed_publication_manifest":
    ...
    payload = {
        "status": "RH-378_archive_verified" if not failures else "RH-378_archive_failed",
