"""Immutable 184-Git-plus-four-remote source closure for RH-398."""
...
SOURCE_RELEASE = "dd63a109dcfa72365c749e0b183820d2611af733"
SOURCE_DIRECTORY = "papers/RH-397-odd-lag-half-span-overlap-mobius-capacity"
SOURCE_RESULT_SHA256 = "d21f3ab160c7cb5cfca1ff04ac7d2104ea8a7802b36eb3e2f07e32cbe1d27e4f"
STANDARD8 = (
...
STANDARD8_SHA256 = {
    "README.md": "18ad513bb327e0c6460c105159fab2c2954cf52023706387c3f6402e95c4a763",
    "THEOREM_LEDGER.md": "210263daa48fee1876e7632db9864dfa4b99422a78f1f2166057cd0d3dff1096",
    "UPDATED_ROADMAP.md": "e68115ccbe8953828df78d3fd31f46eacd1fe1141abde7bbb2c243f14fd7b243",
    "main.tex": "a0ded93cfcd46f48b602e3f276a39e01e99ba8c37d3961316540f3925064ec11",
    "references.bib": "2ef184fbd1594af83c0a16fd8f868c3572d91d86c30d40f98271781ca0044b3b",
    "results/result.json": SOURCE_RESULT_SHA256,
    "results/result.schema.json": "4f16580a613e3e0c3930fd53e3a418023fac96e2cfa15f74ed447a60bea38f83",
    "src/odd_lag_half_span_capacity/core.py": "4b247c0a580c06cfaeb22f29d5b9f80d52bee44fcb44ebd978153bc79e04bcd0",
}
...
EXPECTED_ALL_GIT_SOURCE_DIGEST = "e7341caa25f0787a2e48a4d9c156e0d785b6c2a5516172bdfb25c2ac45377ea8"
EXPECTED_LOGICAL_SOURCE_DIGEST = "4cc752fb7baae977bb15a9420101c5ed37727b1f3f7eecf72afce9dec3c73b13"

DIRECT_PREDECESSOR_ROLE = "direct_release_and_provenance_predecessor_only"
RH396_ENDPOINT_ROLE = (
...
SOURCE_ROLE_CONTRACT_SHA256 = (
    "0892fb28773c9ebe8243a690309b8c3f5ecd4f5481fbc06908fca8abbf53332f"
)
...
def _validate_constants() -> None:
    ...
    expected_contract = {
        ...
        "standard8_sha256": {
            ...
            "main.tex": "a0ded93cfcd46f48b602e3f276a39e01e99ba8c37d3961316540f3925064ec11",
            "references.bib": "2ef184fbd1594af83c0a16fd8f868c3572d91d86c30d40f98271781ca0044b3b",
            "results/result.json": "d21f3ab160c7cb5cfca1ff04ac7d2104ea8a7802b36eb3e2f07e32cbe1d27e4f",
            "results/result.schema.json": "4f16580a613e3e0c3930fd53e3a418023fac96e2cfa15f74ed447a60bea38f83",
            "src/odd_lag_half_span_capacity/core.py": "4b247c0a580c06cfaeb22f29d5b9f80d52bee44fcb44ebd978153bc79e04bcd0",
        },
        "prior_locks": (
    ...
    actual_contract = {
        ...
        "rh396_release": RH396_RELEASE, "rh396_directory": RH396_DIRECTORY,
        ...
        "direct_role": DIRECT_PREDECESSOR_ROLE,
        "rh396_endpoint_role": RH396_ENDPOINT_ROLE,
        "source_role_digest": SOURCE_ROLE_CONTRACT_SHA256,
    ...
    if sha256(role_bytes).hexdigest() != SOURCE_ROLE_CONTRACT_SHA256:
        raise ValueError("source role contract changed")
    hashes = [
...
def released_source_result() -> dict[str, object]:
    ...
    if type(result) is not dict or result.get("status") != "RH-397_STAGE1_CERTIFIED":
...
def _source_paths() -> dict[str, tuple[tuple[str, str, str], ...]]:
    ...
    if type(inherited_rows) is not list or len(inherited_rows) != 172:
        raise RuntimeError("released immutable closure is not 172 rows")
    ...
    return {
        "rh397_immutable_closure": tuple(inherited),
        "rh397_standard8": standard,
        "rh397_prior_external_locks": external,
    }
...
def build_source_closure() -> dict[str, object]:
    ...
    return {
        ...
        "source_roles": deepcopy(SOURCE_ROLE_CONTRACT),
        "git": git, "git_count": 184, "logical_count": 188,
