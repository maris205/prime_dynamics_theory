"""Generate the recursively closed Draft 2020-12 RH-398 result schema."""
...
SCHEMA_ID = "https://example.invalid/schemas/RH-398-result.schema.json"
SCHEMA_TITLE = "RH-398 exact Stage-1 result"
RESULT_BUILDER_BYTES = 22_725
RESULT_BUILDER_SHA256 = "f6a5ec1a4c849faa6c2b5a3e6b3bf311e4be4fc266957c6d30893df869ee4bea"
RESULT_TEST_BYTES = 8_902
RESULT_TEST_SHA256 = "77ab3dd086556f8480389e0410b37f4609b92e85e93e56533b482c418a182e46"
RESULT_PRETTY_BYTES = 187_434
RESULT_PRETTY_SHA256 = "b22bd32fd515cbe98ee1fc946cef7e695273fdffd002cb5e29281ceba7e263f7"
RESULT_CANONICAL_BYTES = 116_612
RESULT_CANONICAL_SHA256 = "82698f0b7720ac3efcb589c38a9bf8b7b7c285637cab54c7389bd9343925178d"
SCHEMA_FIXTURE_BYTES = 325_778
SCHEMA_FIXTURE_SHA256 = "1c7a26bf50e053a6293dfe8f6d226fcef1a3de39abbc62483f430aa729af9134"
SCHEMA_PRETTY_BYTES = 961_955
SCHEMA_PRETTY_SHA256 = "5852ea6e0718185cd063ec56fd5ace000464f95741a2299e15dcd5405d447e8e"
...
def _validate_result_seals() -> None:
    expected = {
        ...
        "id": "https://example.invalid/schemas/RH-398-result.schema.json",
        "title": "RH-398 exact Stage-1 result",
        "builder_bytes": 22725,
        "builder_sha": "f6a5ec1a4c849faa6c2b5a3e6b3bf311e4be4fc266957c6d30893df869ee4bea",
        "test_bytes": 8902,
        "test_sha": "77ab3dd086556f8480389e0410b37f4609b92e85e93e56533b482c418a182e46",
        "pretty_bytes": 187434,
        "pretty_sha": "b22bd32fd515cbe98ee1fc946cef7e695273fdffd002cb5e29281ceba7e263f7",
        "canonical_bytes": 116612,
        "canonical_sha": "82698f0b7720ac3efcb589c38a9bf8b7b7c285637cab54c7389bd9343925178d",
    }
    actual = {
    ...
    def visit(value: object, node: object, current: str) -> None:
        ...
        if kind == "object":
            ...
            if current == "$" and (
                ...
                or node["$id"] != "https://example.invalid/schemas/RH-398-result.schema.json"
                or node["title"] != "RH-398 exact Stage-1 result"
            ):
...
def make_schema_validator(
    compiler: object, builder: object, result_builder: object = _frozen_payload,
):
    ...
    if not callable(compiler) or not callable(builder) or not callable(result_builder):
        raise TypeError("schema compiler, schema builder, and result builder must be callable")

    schema_bytes_literal = 325778
    schema_sha_literal = "1c7a26bf50e053a6293dfe8f6d226fcef1a3de39abbc62483f430aa729af9134"
    schema_pretty_bytes_literal = 961955
    schema_pretty_sha_literal = "5852ea6e0718185cd063ec56fd5ace000464f95741a2299e15dcd5405d447e8e"
    result_bytes_literal = 116612
    result_sha_literal = "82698f0b7720ac3efcb589c38a9bf8b7b7c285637cab54c7389bd9343925178d"
    result_pretty_bytes_literal = 187434
    result_pretty_sha_literal = "b22bd32fd515cbe98ee1fc946cef7e695273fdffd002cb5e29281ceba7e263f7"
    node_counts_literal = {
        "object": 800, "array": 209, "boolean": 574,
        "integer": 1000, "string": 2185, "null": 0,
    }
    ...
    payload_at_construction = result_builder(compare_fresh=False)
    ...
    compiled["$id"] = "https://example.invalid/schemas/RH-398-result.schema.json"
    compiled["title"] = "RH-398 exact Stage-1 result"
    ...
    def semantic(schema: object, payload: object) -> bool:
        try:
            ...
            return (
                ...
                and schema.get("$id") == "https://example.invalid/schemas/RH-398-result.schema.json"
                and schema.get("title") == "RH-398 exact Stage-1 result"
...
def mutate_schema(
    ...
    actions = {
        ...
        "result_hash": lambda: changed_payload.__setitem__("paper", "RH-398-mutated"),
        "schema_bytes": lambda: changed_schema.__setitem__("x-schema-bytes", 325777),
        ...
        "theorem_nested_open": lambda: properties["theorem_contracts"]["properties"]["scope_and_order"].__setitem__("additionalProperties", True),
