"""Generate a recursively closed official Draft 2020-12 RH-387 schema."""
...
def build_schema() -> dict[str, object]:
    ...
    schema["$id"] = "https://example.invalid/schemas/RH-387-result.schema.json"
    schema["title"] = "RH-387 exact release result"
    return schema
