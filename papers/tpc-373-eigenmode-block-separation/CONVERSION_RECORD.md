# TPC-373 source-to-Markdown conversion
...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `ffbb1ffdab58f1e5fe0a2db425698874b5d6b9ada1549b3be12d9e23f486e659`
...
| `Operator and exact layer identity` | 51 | 1 | 3 |
| `Certification` | 83 | 1 | 3 |
| `Finite results` | 99 | 2 | 3 |
| `Interpretation and limits` | 149 | 2 | 3 |
