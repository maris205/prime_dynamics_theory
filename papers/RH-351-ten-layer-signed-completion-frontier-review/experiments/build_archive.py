"""Lock upstream manifests and build the RH-351 publication manifest."""
...
from signed_completion_review import DIRECTORY_NAMES  # noqa: E402


NUMBERS = tuple(range(342, 352))
