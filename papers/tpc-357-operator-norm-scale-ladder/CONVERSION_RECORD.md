# TPC-357 source-to-Markdown conversion
...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `ac834868b62a630e4636fc3cdfbeae3596e9b128816c7b5f440731b9181f53f0`
...
|---|---:|---:|---:|
| `Question and scope` | 42 | 1 | 3 |
| `Finite operator model` | 64 | 1 | 3 |
| `Exact envelopes and numerical protocol` | 92 | 1 | 3 |
| `Results` | 128 | 2 | 3 |
| `Independent controls` | 187 | 2 | 3 |
| `Claim firewall and conclusion` | 204 | 2 | 3 |
