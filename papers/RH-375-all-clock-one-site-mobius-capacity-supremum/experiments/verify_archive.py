"""Verify every RH-375 manifest hash and fixed membership count."""
...
def main() -> None:
    ...
    if manifest.get("status") != "RH-375_fixed_publication_manifest":
    ...
    payload = {
        "status": "RH-375_archive_verified" if not failures else "RH-375_archive_failed",
