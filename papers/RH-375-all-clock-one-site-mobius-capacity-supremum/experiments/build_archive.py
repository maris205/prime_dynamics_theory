"""Build the fixed RH-375 publication and dependency manifest."""
...
LOCAL_MEMBERS = [
    ...
    "THEOREM_LEDGER.md",
    "UPDATED_ROADMAP.md",
    "all-clock-one-site-mobius-capacity-supremum.pdf",
    ...
    "src/all_clock_capacity/__init__.py",
...
def main() -> None:
    payload = {
        "status": "RH-375_fixed_publication_manifest",
