...
\end{equation}
Throughout the moving statements, $\eta_\sigma$ remains bounded and
$k\to\infty$ as $\sigma\to0$.
...
$\gamma_*=0.3503698834605293\ldots$; the two exponents govern different
objects.
...
It checks the displayed formulas, strict positivity at rational sample
