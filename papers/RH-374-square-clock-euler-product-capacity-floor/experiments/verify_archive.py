"""Verify every RH-374 manifest hash and fixed membership count."""
...
def main() -> None:
    ...
    if manifest.get("status") != "RH-374_fixed_publication_manifest":
    ...
    payload = {
        "status": "RH-374_archive_verified" if not failures else "RH-374_archive_failed",
