# TPC-366 source-to-Markdown conversion
...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `10f3e6ece6d28bcfb4e1e1e7596fab17df032ad2fe0ddeeb04038188568f5627`
...
|---|---:|---:|---:|
| `Question and scope` | 37 | 1 | 3 |
| `Finite operator and frozen selection` | 55 | 1 | 3 |
| `Higher-\texorpdfstring{$Q$}{Q} audit` | 101 | 1 | 3 |
| `Exact and independent verification` | 153 | 2 | 3 |
| `Claim firewall and route decision` | 170 | 2 | 3 |
| `Conclusion` | 197 | 2 | 3 |
