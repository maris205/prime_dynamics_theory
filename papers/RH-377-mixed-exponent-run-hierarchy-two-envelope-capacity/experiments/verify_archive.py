"""Verify every RH-377 manifest hash and fixed membership count."""
...
def main() -> None:
    ...
    if manifest.get("status") != "RH-377_fixed_publication_manifest":
    ...
    payload = {
        "status": "RH-377_archive_verified" if not failures else "RH-377_archive_failed",
