...
For every finite real symmetric matrix $T$, $$\lVert\,\cdot\,\rVert_2{T}\leq\max_u\sum_t|T(u,t)|=:S(T),
 ...
 \label{eq:envelopes}$$ These are exact finite inequalities. Positivity of every declared $G_u$ makes the congruence in [\[eq:norm\]](main.tex#L65){reference-type="eqref" reference="eq:norm"} a well-defined finite real symmetric matrix. None of these facts supplies a bound uniform in $x$ or $N$.
