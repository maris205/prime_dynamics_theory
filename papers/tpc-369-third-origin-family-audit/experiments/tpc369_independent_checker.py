#!/usr/bin/env python3
"""Independent reverse-shell replay for the TPC-369 third-family audit."""
...
def validate_header(document: dict[str, Any]) -> dict[str, Any]:
    ...
    repair = payload.get("exact_theorem", {}).get("anchor_repair", {})
    need(repair == {
...
def main() -> int:
    ...
    try:
        ...
        print("TPC369_INDEPENDENT_CHECK=PASS rows=" + str(checked) +
        ...
        print("TPC369_INDEPENDENT_CHECK=FAIL " + str(error), file=sys.stderr)
        return 1
