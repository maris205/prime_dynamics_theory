...
Table [1](#tab:beta) gives the complete census. Every row receives a true eigenvalue computation, while Schur and Frobenius values remain distinct upper envelopes.
