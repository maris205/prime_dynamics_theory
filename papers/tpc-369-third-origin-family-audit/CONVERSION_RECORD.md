# TPC-369 source-to-Markdown conversion
...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `a91b334ca999cbef29f6c82a2b3c533ece9e926ab28fb9d442c7ff784220b0bd`
...
|---|---:|---:|---:|
| `Question and claim boundary` | 38 | 1 | 3 |
| `Finite operator and frozen protocol` | 52 | 1 | 3 |
| `Exact-anchor obstruction and repair` | 99 | 1 | 3 |
| `Complete finite audit` | 117 | 2 | 3 |
| `Independent and hostile verification` | 155 | 2 | 3 |
| `Claim firewall and route decision` | 172 | 2 | 3 |
| `Conclusion` | 204 | 2 | 3 |
