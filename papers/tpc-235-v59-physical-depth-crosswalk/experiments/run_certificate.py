#!/usr/bin/env python3
"""Write or check the deterministic TPC-235 certificate."""
...
from v59_crosswalk import build_certificate  # noqa: E402
...
def main() -> None:
    ...
    if args.write:
        ...
        print("TPC235_CERTIFICATE=WRITTEN")
    elif args.check:
        if json.loads(target.read_text(encoding="utf-8")) != generated:
            raise SystemExit("TPC235 certificate mismatch")
        print("TPC235_CERTIFICATE=PASS")
    else:
