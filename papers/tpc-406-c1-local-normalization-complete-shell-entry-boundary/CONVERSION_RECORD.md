...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `f5373712b537d23c3d4818301ba3f7534802a38b2a1ab2f2aee5dfcc613653e5`
...
|---|---:|---:|---:|
| `Scope and complete-shell model` | 26 | 1 | 5 |
| `Complete-shell adjacent-entry theorem` | 57 | 1 | 5 |
| `Exact complete-shell certificate` | 80 | 1 | 4 |
| `Route boundary` | 107 | 2 | 2 |
| `Reproduction` | 132 | 3 | 1 |
