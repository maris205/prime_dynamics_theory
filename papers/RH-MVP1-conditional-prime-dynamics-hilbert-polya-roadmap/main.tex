...
\title{\textbf{A Minimum Viable Hilbert--Polya Roadmap for Prime Dynamics}\\
\large A 160-Layer Audit, Five Bold Interfaces, and a Conditional Spectral-Divisor Closure Theorem}
\author{Liang Wang}
\date{July 2026}
...
\begin{abstract}
One hundred and sixty RH-numbered papers have developed the prime-dynamics
