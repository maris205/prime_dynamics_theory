...
from endpoint_spectral_review import batch_status  # noqa: E402


def main() -> None:
    payload = {"status": "rh321_ten_layer_endpoint_spectral_frontier_review"}
    ...
    print(json.dumps({"papers": len(payload["paper_numbers"]), "complete": payload["complete_count"]}))
