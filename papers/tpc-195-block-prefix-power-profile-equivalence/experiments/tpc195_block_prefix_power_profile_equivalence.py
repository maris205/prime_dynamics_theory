...
EXPECTED_SCHEMA_ID="tpc-195-block-prefix-power-profile-equivalence-v1.schema.json"
EXPECTED_AUDIT_SCHEMA_ID="tpc-195-block-prefix-power-profile-equivalence-audit-v1.schema.json"
