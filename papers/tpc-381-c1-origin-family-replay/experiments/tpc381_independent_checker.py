#!/usr/bin/env python3
"""Independent reverse-shell replay for the TPC-381 origin-family panel.

The checker deliberately does not import the TPC-381 producer.  It rebuilds
...
SPECTRAL_CAP = 0.64
SCHUR_CAP = 0.83
EXACT_INTERVAL = (1400001, 1400014)
EXACT_Q = 8
...
def main() -> int:
    ...
    try:
        ...
        compact = ";".join(
            ...
            for law in LAWS)
        print("TPC381_INDEPENDENT_CHECK=PASS rows=36 failures=6 "
              "profiles=" + compact)
        return 0
    except (Failure, OSError, ValueError, TypeError, KeyError,
            json.JSONDecodeError) as error:
        print("TPC381_INDEPENDENT_CHECK=FAIL " + str(error),
              file=sys.stderr)
        return 1
