...
Table [1](#tab:phase) gives the full beta census. The effective shell count is \((\sum_pw_p^2)^2/\sum_pw_p^4\), divided by the literal shell cardinality; it is a diagnostic, not a new normalization theorem.
...
Table [2](#tab:q) separates the inherited beta=0 normalization from the beta=2 phase point by shell. Each shell column aggregates all three origins, two counts, two exponents, and four laws, hence 48 rows.
