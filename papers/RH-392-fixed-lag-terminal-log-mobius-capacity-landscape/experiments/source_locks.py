"""Immutable 106-Git-plus-three-remote source closure for RH-392."""
...
from fixed_lag_capacity.core import canonical_json_bytes, exact_equal, loads_strict  # noqa: E402


SOURCE_RELEASE = "8b1a875b4bbefd955a419593951ce2d09987ac6f"
SOURCE_DIRECTORY = "papers/RH-389-active-c11-terminal-log-all-clock-capacity"
SOURCE_RESULT_SHA256 = "3c551568aab4e0965b2b0236d9f684e1f953dc36ecbc575e6e007c5f15bfd310"
STANDARD8 = (
...
EXPECTED_GROUP_DIGESTS = {
    "rh389_immutable_closure": "8a674e5d60237b4463e1f68ef79965633ed11a4d098957e5be44e05f471174cb",
    "rh389_standard8": "87bbdb455fa5217404d863d1054b4ae408de69da6701ff42ac439ec9bfe1605c",
    "rh389_prior_external_locks": "a03e4ba7d8b5b054acc95288c70e753bf22b82bb1957f635891b28682c67840e",
}
EXPECTED_ALL_GIT_SOURCE_DIGEST = "3b32865a14618a605915beb8eab6432b048fca49718b69519697ef861cbe650f"
EXPECTED_LOGICAL_SOURCE_DIGEST = "39bf8e9030b511e85fdf26a7c71722c3e4be5bc74bc738aa253bbc29c94517f9"
...
def released_source_result() -> dict[str, object]:
    ...
    if type(result) is not dict or result.get("status") != "RH-389_active_c11_terminal_log_all_clock_capacity_certified":
        raise RuntimeError("released source status changed")
    locks = result.get("source_locks")
    if type(locks) is not dict or (locks.get("git_count"), locks.get("remote_count"), locks.get("logical_count")) != (95, 3, 98):
...
def _source_paths() -> dict[str, tuple[tuple[str, str | None], ...]]:
    ...
    if type(inherited_rows) is not list or len(inherited_rows) != 95:
        raise RuntimeError("released immutable closure is not 95 rows")
    ...
    return {
        "rh389_immutable_closure": tuple(inherited),
        "rh389_standard8": standard,
        "rh389_prior_external_locks": external,
    }
...
def build_git_source_locks(*, commit: str = SOURCE_RELEASE) -> dict[str, object]:
    ...
    return {
        ...
        "pass": release_pass and live_pass and digest_pass and len(entries) == 106 and path_count == 106,
...
def build_source_closure() -> dict[str, object]:
    ...
    return {
        "git": git, "git_count": 106, "logical_count": 109,
