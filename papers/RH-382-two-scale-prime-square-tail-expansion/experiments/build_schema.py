"""Generate the recursively closed Draft 2020-12 RH-382 result schema."""
...
def exact_schema(value: object) -> dict[str, object]:
    """Return a closed exact structural schema; bool is kept distinct from int."""
...
def build_schema() -> dict[str, object]:
    ...
    return {
        ...
        "$id": "https://example.invalid/RH-382/result.schema.json",
        "title": "RH-382 exact result ledger",
        **schema,
    }
...
def main() -> None:
    ...
    print(json.dumps({"status": "RH-382_closed_schema_built", "bytes": OUTPUT.stat().st_size}, sort_keys=True))
