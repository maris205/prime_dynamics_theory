# TPC-376 source-to-Markdown conversion
...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `fa467b50ba3a40590eeda3fefb080c3997c88facfaf3c0abbf332cac6f0ccfa7`
...
|---|---:|---:|---:|
| `Question and claim boundary` | 46 | 1 | 3 |
| `Finite normalized object` | 63 | 1 | 3 |
| `Response-blind holdout protocol` | 98 | 1 | 3 |
| `Results` | 133 | 2 | 3 |
| `Audit and reproducibility` | 179 | 2 | 3 |
| `Conclusion and next question` | 195 | 2 | 3 |
