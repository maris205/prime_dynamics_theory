# TPC-375 source-to-Markdown conversion
...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `d1c94d8ff9cc75c479ac02ce6c0285d49265af54ce3b6c7314c0d4ead3a6d85d`
...
|---|---:|---:|---:|
| `Motivation and frozen panel` | 32 | 1 | 3 |
| `Operator and nested bands` | 47 | 1 | 3 |
| `Certification` | 81 | 1 | 3 |
| `Finite bandwidth census` | 98 | 2 | 3 |
| `Interpretation and limits` | 141 | 2 | 3 |
...
- Source has `6` displayed-equation markers before conversion; the Markdown retains the corresponding TeX math as Pandoc inline/display math.
...
- **Scope gate:** The finite operator, nested masks, exact identities, certification protocol, and stated bandwidth census remain finite-scope objects; no global bandwidth optimum or arithmetic theorem is inferred.
