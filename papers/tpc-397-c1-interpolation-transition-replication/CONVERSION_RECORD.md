...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `67e14be927bde5932b38169722a3e8962b1f3dfd4f469db97450fc6427e54ce4`
...
| `Finite construction` | 50 | 1 | 2 |
| `Statistics and certification` | 84 | 2 | 3 |
| `Results` | 104 | 2 | 1 |
| `Interpretation and next question` | 149 | 2 | 4 |
| `Reproduction` | 170 | 3 | 1 |
