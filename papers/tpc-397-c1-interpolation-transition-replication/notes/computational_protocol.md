# TPC-397 computational protocol
...
thread per process.  The parent TPC-396 certificate is parsed canonically and
its code and JSON hashes are checked before endpoint means are used.

The current family is `a_j=6400001+401j`, with selected indices
