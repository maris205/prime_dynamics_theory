...
Table [1](main.tex#L113){reference-type="ref" reference="tab:summary"} reports the normalization-level aggregates. The entry “origin” counts the four interpolation coefficients; “cal” and “transfer” use the fixed three-percent caps.
