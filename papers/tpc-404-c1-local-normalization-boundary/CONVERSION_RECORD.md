...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `53270221556d460152d98e4befe03a4633ba559f86150b3552783bb48e89fb83`
...
|---|---:|---:|---:|
| `Question and finite model` | 25 | 1 | 4 |
| `Exact local identities` | 48 | 1 | 3 |
| `Certificate and observations` | 70 | 1 | 3 |
| `Interpretation and route boundary` | 95 | 2 | 4 |
| `Reproduction` | 124 | 3 | 1 |
