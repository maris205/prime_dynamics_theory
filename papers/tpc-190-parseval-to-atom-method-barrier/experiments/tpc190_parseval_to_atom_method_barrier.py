...
REPO=HERE.parents[2]
PAYLOAD=HERE/"tpc190_parseval_to_atom_method_barrier.json"
AUDIT=HERE/"tpc190_parseval_to_atom_method_barrier_audit.json"
...
def main():
    ...
    print(json.dumps({"paper":190,"verdict":p["verdict"],"check":ns.check,"mutations":8},sort_keys=True))
