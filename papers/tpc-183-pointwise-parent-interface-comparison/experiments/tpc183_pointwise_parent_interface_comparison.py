...
REPO=HERE.parents[2]
PAYLOAD=HERE/"tpc183_pointwise_parent_interface_comparison.json"
AUDIT=HERE/"tpc183_pointwise_parent_interface_comparison_audit.json"
...
def main():
    ...
    print(json.dumps({"paper":183,"verdict":p["verdict"],"check":ns.check,"mutations":8},sort_keys=True))
