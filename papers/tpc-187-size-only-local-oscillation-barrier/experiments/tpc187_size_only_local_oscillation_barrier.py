...
REPO=HERE.parents[2]
PAYLOAD=HERE/"tpc187_size_only_local_oscillation_barrier.json"
AUDIT=HERE/"tpc187_size_only_local_oscillation_barrier_audit.json"
...
def main():
    ...
    print(json.dumps({"paper":187,"verdict":p["verdict"],"check":ns.check,"mutations":8},sort_keys=True))
