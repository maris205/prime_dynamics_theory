"""Build the fixed RH-373 publication and dependency manifest."""
...
LOCAL_MEMBERS = [
    ...
    "THEOREM_LEDGER.md",
    "UPDATED_ROADMAP.md",
    "composite-clock-mobius-capacity-floor.pdf",
    ...
    "src/composite_clock/__init__.py",
    "src/composite_clock/core.py",
...
def main() -> None:
    payload = {
        "status": "RH-373_fixed_publication_manifest",
