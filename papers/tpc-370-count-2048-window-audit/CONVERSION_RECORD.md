# TPC-370 source-to-Markdown conversion
...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `244c0e45e34fbe1f8745e02b65c9a258ef5641221691162d0fa74b8abf1d42eb`
...
|---|---:|---:|---:|
| `Question and claim boundary` | 36 | 1 | 3 |
| `Finite operator and frozen protocol` | 49 | 1 | 3 |
| `Inherited exact anchor` | 91 | 1 | 3 |
| `Complete count-2048 audit` | 101 | 2 | 3 |
| `Independent and hostile verification` | 147 | 2 | 3 |
| `Claim firewall and route decision` | 163 | 2 | 3 |
| `Conclusion` | 195 | 2 | 3 |
