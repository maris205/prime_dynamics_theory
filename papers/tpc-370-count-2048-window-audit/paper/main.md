...
Table [1](#tab:phase) gives the complete phase census. Every row receives a true eigenvalue endpoint computation; Schur and Frobenius values remain separate finite envelopes.
