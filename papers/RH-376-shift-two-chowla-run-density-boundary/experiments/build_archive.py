"""Build the fixed RH-376 publication and dependency manifest."""
...
LOCAL_MEMBERS = [
    ...
    "shift-two-chowla-run-density-boundary.pdf",
    "src/shift_two_chowla/__init__.py",
    "src/shift_two_chowla/core.py",
...
def main() -> None:
    payload = {
        "status": "RH-376_fixed_publication_manifest",
