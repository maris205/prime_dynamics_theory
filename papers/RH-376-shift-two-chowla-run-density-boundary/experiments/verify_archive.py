"""Verify every RH-376 manifest hash and fixed membership count."""
...
def main() -> None:
    ...
    if manifest.get("status") != "RH-376_fixed_publication_manifest":
    ...
    payload = {
        "status": "RH-376_archive_verified" if not failures else "RH-376_archive_failed",
