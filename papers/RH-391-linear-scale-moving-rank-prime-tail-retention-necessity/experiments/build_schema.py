"""Generate the recursively closed official Draft 2020-12 RH-391 schema."""
...
def exact_schema(value: object) -> dict[str, object]:
    ...
    if type(value) is list:
        schema: dict[str, object] = {"type": "array", "items": False, "minItems": len(value), "maxItems": len(value)}
        if value:
...
def build_schema() -> dict[str, object]:
    ...
    schema["$id"] = "https://example.invalid/schemas/RH-391-result.schema.json"
    schema["title"] = "RH-391 exact release result"
    return schema
