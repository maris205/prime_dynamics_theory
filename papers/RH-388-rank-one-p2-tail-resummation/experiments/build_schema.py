"""Generate the recursively closed official Draft 2020-12 RH-388 schema."""
...
def build_schema() -> dict[str, object]:
    ...
    schema["$id"] = "https://example.invalid/schemas/RH-388-result.schema.json"
    schema["title"] = "RH-388 exact release result"
    return schema
