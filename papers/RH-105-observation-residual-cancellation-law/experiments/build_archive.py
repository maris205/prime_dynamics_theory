"""Build RH-105 dependency, result, and publication hashes."""
...
def main() -> None:
    ...
    dependency = {
        "status": "all_rh105_inputs_sources_and_publication_artifacts_hashed",
    ...
    audit = json.loads((ROOT / "results" / "observation_residual_audit.json").read_text(encoding="utf-8"))
    result_paths = [
    ...
    summary = {
        "status": "rh105_observation_residual_cancellation_archived",
        "theorem": {
            "full_future_residual_transfer": True,
            "signed_observation_residual_cancellation": True,
            "matched_scale_factorization": True,
            "finite_propagator_fallback": True,
