#!/usr/bin/env python3
"""Write or check the deterministic TPC-236 certificate."""
...
from physical_multiwrap import build_certificate  # noqa: E402
...
def main() -> None:
    ...
    if args.write:
        ...
        print("TPC236_CERTIFICATE=WRITTEN")
    elif args.check:
        if json.loads(target.read_text(encoding="utf-8")) != generated:
            raise SystemExit("TPC236 certificate mismatch")
        print("TPC236_CERTIFICATE=PASS")
    else:
