...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `a17026aa1d2d9365ee81ab8774f7c040b7b301ec7a7ca40032009fd563bfa50d`
...
| `Finite proxy` | 57 | 1 | 2 |
| `Forecast trajectory` | 73 | 1 | 2 |
| `Certification and finite result` | 102 | 2 | 4 |
| `Conclusion and next clue` | 156 | 2 | 4 |
| `Reproduction` | 169 | 3 | 1 |
