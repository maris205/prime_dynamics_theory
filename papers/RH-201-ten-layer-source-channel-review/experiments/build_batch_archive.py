"""Build the RH-192--201 batch publication manifest."""
...
def main() -> None:
    ...
    payload = {
        "status": "rh192_201_batch_publication_manifest",
        "paper_numbers": list(NUMBERS),
        "file_count": len(files),
        "files": {str(path.relative_to(PAPERS)): sha256(path) for path in files},
    }
