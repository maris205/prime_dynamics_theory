"""Lock upstream manifests and build the RH-341 publication manifest."""
...
from actual_frontier_review import DIRECTORY_NAMES  # noqa: E402


NUMBERS = tuple(range(332, 342))
