#!/usr/bin/env python3
"""Independent literal replay for TPC-415's three-shell height ladder."""
from __future__ import annotations
import hashlib,json,math,sys
from fractions import Fraction
from pathlib import Path
sys.set_int_max_str_digits(1_000_000)
ROOT=Path(__file__).resolve().parents[3]; CERT=ROOT/'papers/tpc-415-c1-three-shell-height-extension/results/tpc415_certificate.json'; SCHEMA='TPC415_C1_THREE_SHELL_HEIGHT_EXTENSION_V1'; STATUS='PROVED_EXACT_FINITE_THREE_SHELL_HEIGHT_EXTENSION'; QS,COUNTS,HEIGHTS,B=(65536,131072,262144),(5709,10749,20390),(16,32,66,128),1_000_000
def need(c,m):
