...
REPO=HERE.parents[2]
PAYLOAD=HERE/"tpc184_bad_endpoint_literal_target_contract.json"
AUDIT=HERE/"tpc184_bad_endpoint_literal_target_contract_audit.json"
PAYLOAD_SCHEMA=HERE.parent/"schemas"/"tpc184-bad-endpoint-literal-target-contract-v1.schema.json"
AUDIT_SCHEMA=HERE.parent/"schemas"/"tpc184-bad-endpoint-literal-target-contract-audit-v1.schema.json"
...
def validate_payload(p):
    ...
    require(type(p["paper"]) is int and p["paper"]==184,"PAPER")
...
def main():
    ...
    print(json.dumps({"paper":184,"verdict":p["verdict"],"check":ns.check,"mutations":8},sort_keys=True))
