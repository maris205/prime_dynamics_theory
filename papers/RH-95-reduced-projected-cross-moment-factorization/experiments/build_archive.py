"""Build RH-95 dependency, result, and publication hashes."""
...
def main() -> None:
    external = {
        ...
        "rh94_roadmap": PAPERS / "RH-94-source-seeded-four-direction-horizon-refresh" / "UPDATED_ROADMAP.md",
    }
    ...
    publications = [
        ...
        ROOT / "figures" / "reduced_cross_moment_factorization.pdf",
        ROOT / "figures" / "reduced_cross_moment_factorization.png",
        ROOT / "main.pdf", ROOT / "reduced-projected-cross-moment-factorization.pdf",
    ]
    dependency = {
        "status": "all_rh95_inputs_sources_and_publication_artifacts_hashed",
    ...
    audit = json.loads((ROOT / "results" / "reduced_cross_factorization_audit.json").read_text(encoding="utf-8"))
    result_paths = [ROOT / "results" / "reduced_cross_factorization_audit.json", ROOT / "results" / "reduced_cross_factorization_smoke.json", dependency_path]
    summary = {
        "status": "rh95_reduced_projected_cross_moment_factorization_archived",
        "theorem": {
            "projected_cross_gram_identity": True,
            "cross_cubic_moment_identity": True,
            "reduced_compressed_factorization": True,
            "threshold_conditioning_bounds": True,
        },
