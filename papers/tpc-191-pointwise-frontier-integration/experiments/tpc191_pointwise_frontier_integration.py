...
REPO=HERE.parents[2]
PAYLOAD=HERE/"tpc191_pointwise_frontier_integration.json"
AUDIT=HERE/"tpc191_pointwise_frontier_integration_audit.json"
...
def main():
    ...
    print(json.dumps({"paper":191,"verdict":p["verdict"],"check":ns.check,"mutations":8},sort_keys=True))
