...
Table [1](main.tex#L122){reference-type="ref" reference="tab:census"} gives the complete phase census. The beta=2 maximum is well below both working caps, while the unweighted beta=0 control retains a strong all-plus phase.
