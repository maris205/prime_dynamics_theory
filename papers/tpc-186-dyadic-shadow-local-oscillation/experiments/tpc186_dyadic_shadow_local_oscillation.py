...
REPO=HERE.parents[2]
PAYLOAD=HERE/"tpc186_dyadic_shadow_local_oscillation.json"
AUDIT=HERE/"tpc186_dyadic_shadow_local_oscillation_audit.json"
...
def main():
    ...
    print(json.dumps({"paper":186,"verdict":p["verdict"],"check":ns.check,"mutations":8},sort_keys=True))
