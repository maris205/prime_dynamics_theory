# TPC-361 source-to-Markdown conversion
...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `8389ee6f17d7d6ca927554e23bff048e13d19bb23178a7ab1a89aba18ed306f9`
...
| `Finite operator` | 54 | 1 | 3 |
| `Frozen selection and replay` | 86 | 1 | 3 |
| `Results` | 113 | 2 | 3 |
| `Independent audit and exact anchor` | 164 | 2 | 3 |
| `Claim firewall and route decision` | 180 | 2 | 3 |
| `Conclusion` | 209 | 2 | 3 |
