...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `473ace2fe82dde740d2f0979e2835a3bf8096c439562aecd37977cd7922fc8e9`
...
|---|---:|---:|---:|
| `Finite object` | 20 | 1 | 2 |
| `CRT construction` | 32 | 1 | 2 |
| `Exact certificate` | 56 | 2 | 2 |
| `Scope and obstruction` | 78 | 2 | 3 |
| `Reproduction` | 95 | 2 | 1 |
