"""Build the fixed RH-390 publication and dependency manifest."""
...
LOCAL_MEMBERS = (
    ...
    "growing-rank-prime-tail-filtration.pdf",
    "main.log",
    "main.pdf",
    "main.tex",
    "pyproject.toml",
    ...
    "src/growing_rank_filtration/__init__.py",
...
PUBLICATION_PDFS = {"main.pdf", "growing-rank-prime-tail-filtration.pdf"}
REMOTE_PAYLOAD_HASHES = set(source_locks.REMOTE_PAYLOAD_HASHES)
SOURCE_COMMITS = {"rh388_release": source_locks.RH388_RELEASE}
...
def validated_result_git_source_map(result: dict[str, object]) -> dict[str, str]:
    ...
    if (
        ...
        or git_locks.get("count") != 87
    ):
        raise RuntimeError("result Git source-lock count is not 87")
    output: dict[str, str] = {}
...
def build_payload() -> dict[str, object]:
    ...
    semantic_match = publication["main.pdf"] == publication["growing-rank-prime-tail-filtration.pdf"]
    ...
    return {
        "status": "RH-390_fixed_publication_manifest",
