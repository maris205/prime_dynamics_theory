"""Build RH-109 dependency, result, and publication hashes."""
...
def main() -> None:
    ...
    dependency = {
        "status": "all_rh109_inputs_sources_and_publication_artifacts_hashed",
    ...
    audit = json.loads((ROOT / "results" / "exterior_fourth_support_audit.json").read_text(encoding="utf-8"))
    result_paths = [
    ...
    summary = {
        "status": "rh109_exterior_power_fourth_cross_support_archived",
        "theorem": {
