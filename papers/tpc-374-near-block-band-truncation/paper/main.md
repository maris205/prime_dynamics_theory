...
Table [1](main.tex#L112){reference-type="ref" reference="tab:census"} gives the full and band cap-failure census. The band preserves the six beta=2 failures exactly: all three origins at $Q=2048,8192$. It also preserves the absence of beta=2 Schur failures.
