#!/usr/bin/env python3
"""Fresh sieve and literal mask replay for TPC-414."""
from __future__ import annotations
import hashlib,json,math,sys
from fractions import Fraction
from pathlib import Path
sys.set_int_max_str_digits(1_000_000)
ROOT=Path(__file__).resolve().parents[3]; CERT=ROOT/'papers/tpc-414-c1-three-shell-pooled-extension/results/tpc414_certificate.json'; SCHEMA='TPC414_C1_THREE_SHELL_POOLED_EXTENSION_V1'; STATUS='PROVED_EXACT_FINITE_THREE_SHELL_POOLED_EXTENSION'; QS,COUNTS,H,N,B=(65536,131072,262144),(5709,10749,20390),66,264,1_000_000
def need(c,m):
