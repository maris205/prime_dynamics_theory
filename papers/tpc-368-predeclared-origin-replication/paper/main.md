...
Table [1](#tab:beta) gives the census over all rows. Every law receives a true eigenvalue computation; Schur and Frobenius quantities are retained as separate envelopes.
