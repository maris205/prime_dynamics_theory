"""Build the fixed RH-397 publication dependency manifest."""
...
SEMANTIC_PDF = "odd-lag-half-span-overlap-mobius-capacity.pdf"
LOCAL_MEMBERS = (
    ".gitignore",
    "FORMAT_AUDIT.md",
    "GATE_AUDIT.md",
    ...
    "src/odd_lag_half_span_capacity/__init__.py",
...
SOURCE_COMMITS = {
    "rh396_release": source_locks.SOURCE_RELEASE,
...
FROZEN_STAGE_DIGESTS = {
    "experiments/build_result.py": "5ccbc206c98020ec1afc08c7aa7a7157031907be3d5ad48e707b13f03a0ef3a2",
    "experiments/build_schema.py": "ee0919256849f9403239ed5c6aa96d82a0a8acc8d061702165c0e9ba1e735638",
    "experiments/source_locks.py": "e39d4d874ae1aaa21480db9d99837d6c681164e6b667990e90be0ee97da98d91",
    "main.log": "3ff4d9317931ff356e76340cca833fba7fc50f38668234fe5ff4cec32c402aba",
    "main.pdf": "be06c3bcd37acb7f2144cd390423ae207f9b412ffd833a8156a317c59dd44ea6",
    "main.tex": "a0ded93cfcd46f48b602e3f276a39e01e99ba8c37d3961316540f3925064ec11",
    "pyproject.toml": "5f5612112d1e2e357ac987a82ed3d9fad2afa57dc8b54937fd1f507a0b81726b",
    ...
    "src/odd_lag_half_span_capacity/__init__.py": "79f175e4dd311ac760cb082778037413a0a172d219f8288815f31e8f53a4d97c",
    "src/odd_lag_half_span_capacity/core.py": "4b247c0a580c06cfaeb22f29d5b9f80d52bee44fcb44ebd978153bc79e04bcd0",
    "tests/test_core.py": "2ae8870ec42bc4c5b0c01d0445665adc6f04f17e5befeafe8b4c0944659e0af2",
    "tests/test_result.py": "a0e3418ca4e9ba266c249a6e375cd7664c43b81e5d888d4dfc0a1d9fffe8e3fc",
    "tests/test_schema.py": "71eed87b1967292cb0694eac07142f0630ac1d3920450fdf2fde31bcbacaa545",
    "tests/test_source_locks.py": "45fedbdd12120a02e4dfbf5095e8d83d966696bac29a13cc6acd939cfa3e01a6",
}
BOOLEAN_KEYS = (
...
def validated_result_git_source_map(result: dict[str, object]) -> dict[str, str]:
    ...
    if (
        ...
        or git_locks.get("count") != 172
        or not exact_equal(git_locks.get("group_sizes"), expected_groups)
    ):
        raise RuntimeError("result Git closure is not 172=160+8+4")
    output: dict[str, str] = {}
...
def build_payload() -> dict[str, object]:
    ...
    logical_pass = (
        ...
        and source_contract.get("git_count") == 172
        and source_contract.get("remote_count") == 4
        and source_contract.get("logical_count") == 176
    ...
    if not logical_pass:
        raise RuntimeError("172+4=176 logical source closure is not sealed")
    ...
    return {
        "status": "RH-397_fixed_publication_manifest",
