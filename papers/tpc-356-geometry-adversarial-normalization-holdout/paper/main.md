...
Table [1](#tab:summary) gives the minimum, maximum, and mean of \(\kappa\) across the 54 rows for each sign law. The raw and normalized operators are evaluated on exactly the same source and response vectors.
