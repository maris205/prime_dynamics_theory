...
REPO=HERE.parents[2]
PAYLOAD=HERE/"tpc185_prefix_block_equivalence.json"
AUDIT=HERE/"tpc185_prefix_block_equivalence_audit.json"
...
def main():
    ...
    print(json.dumps({"paper":185,"verdict":p["verdict"],"check":ns.check,"mutations":8},sort_keys=True))
