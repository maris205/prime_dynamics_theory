...
Table [1](main.tex#L115){reference-type="ref" reference="tab:q"} separates the control shell from the first-failure and stress shells. “Trim max” is the largest value over both deletion rules and all 48 law rows at that $Q$.
