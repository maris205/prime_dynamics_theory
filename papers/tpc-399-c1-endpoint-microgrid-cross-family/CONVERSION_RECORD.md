...
- **PDF:** [`paper/main.pdf`](paper/main.pdf), SHA-256 `8638ec70073247a8236aa6852d86faaadb28ee13132b144c917b076ec429795d`
...
| `Finite construction` | 55 | 1 | 2 |
| `Diagnostics and frozen parent interface` | 95 | 2 | 5 |
| `Results` | 140 | 2 | 1 |
| `Interpretation and route ledger` | 177 | 3 | 4 |
| `Reproduction` | 212 | 3 | 1 |
