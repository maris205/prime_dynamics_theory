# TPC big road V37: loss-budgeted centered shift-packet compiler

更新时间：2026-08-09

状态：`UNNUMBERED_WORKING_ARTIFACT / EXACT_PACKETIZATION_PLUS_CONDITIONAL_K_OVERHEAD_THRESHOLD`

高层、可持续更新的岛屿/桥梁文字路线图见 [`TPC_ROUTE_MAP.md`](TPC_ROUTE_MAP.md)。
该地图用于导航；当前数学事实仍由根目录 `TPC_HANDOFF.md` 与当前 proof/checker 控制。

当前主路线见第 37 节及 `bridge_b_loss_budgeted_shift_packet_compiler.md`；checker为
`tpc_bridge_b_loss_budgeted_shift_packet_checker.py`。第 36 节及
