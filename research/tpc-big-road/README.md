# TPC big road V36: multiroute binary ratio-core atlas

更新时间：2026-08-09

状态：`UNNUMBERED_WORKING_ARTIFACT / EXACT_RECOLLAPSE_PLUS_CONDITIONAL_E_OR_K_OR_X_COMPILER`

高层、可持续更新的岛屿/桥梁文字路线图见 [`TPC_ROUTE_MAP.md`](TPC_ROUTE_MAP.md)。
该地图用于导航；当前数学事实仍由根目录 `TPC_HANDOFF.md` 与当前 proof/checker 控制。

当前主路线见第 36 节及 `bridge_b_multiroute_ratio_core_atlas.md`；checker为
`tpc_bridge_b_multiroute_ratio_core_checker.py`。第 35 节与
