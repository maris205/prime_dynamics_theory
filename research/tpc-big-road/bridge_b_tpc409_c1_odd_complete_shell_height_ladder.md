# Bridge B: TPC-409 odd complete-shell height ladder

TPC-409 fixes `Q=65536`, retains all `5709` primes in the complete odd shell,
and tests `H=16,32,66,128` with `N=4H`.  The explicit profile has
`m_minus=2854` and `m_plus=2855`.  At every height the exact proxy entry obeys
