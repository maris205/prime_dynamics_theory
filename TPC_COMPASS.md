...
更新时间：2026-08-28
状态：`BOLD_CHANNEL_V147 / MAGNITUDE_WEIGHTED_SIGNED_RAYLEIGH_ATLAS`
claim level：`PROVED_EXACT_TRACE_NORMALIZED_SIGNED_QUADRATIC_IDENTITY_PLUS_NUMERICALLY_CERTIFIED_FINITE_GLOBAL_SIGN_ATLAS`
编号事实终点：TPC-294；TPC-294 trigger：`true`
