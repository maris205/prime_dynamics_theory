...
更新时间：2026-08-25
状态：`BOLD_CHANNEL_V103 / COHERENCE_CONTROLLED_GRAM_QUADRATIC_SHARPNESS`
claim level：`PROVED_STRUCTURAL_L1_COHERENCE_CONTROLLED_GRAM_QUADRATIC_SHARPNESS`
编号事实终点：TPC-250；TPC-250 trigger：`true`

当前 TPC-250 入口：proof 为
...
`papers/tpc-250-coherence-controlled-gram-quadratic-sharpness/`。它把 TPC-249 的 exact
shared-lane Gram quadratic 压入由 `D`、`L`、`mu` 决定的 sharp two-sided
envelope，并将结果继承到 independent/global support radii。
