...
更新时间：2026-08-12
状态：`BOLD_CHANNEL_V56 / PRUNED_DYADIC_MAXIMAL_GATE_A_COMPILED_WITH_LARGE_BLOCK_AND_TRANSVERSE_PIERS_OPEN`
claim level：`EXACT_PRUNED_DYADIC_MAXIMALIZATION_AND_LEAF_PAYMENT_WITHOUT_ARITHMETIC_PROMOTION`
编号事实终点：TPC-206；TPC-207 trigger：`false`

本文件把 TPC-1--206 看成 200 多个可审计研究节点，而不是 200 多篇彼此独立的
传统论文。它只做三件事：压缩旧地图、选一条主干、集中管理大胆假设。V56 的完整
