...
更新时间：2026-08-28
状态：`BOLD_CHANNEL_V146 / SIGNED_SHELL_MAXCUT_ATLAS`
claim level：`PROVED_EXACT_ALL_POSITIVE_MAXCUT_PLUS_NUMERICALLY_CERTIFIED_FINITE_SIGNED_SHELL_FRUSTRATION_ATLAS`
编号事实终点：TPC-293；TPC-293 trigger：`true`
