...
更新时间：2026-08-28
状态：`BOLD_CHANNEL_V144 / SIGNED_SCHUR_CANCELLATION_ATLAS`
claim level：`PROVED_EXACT_SIGNED_TWO_PRIME_SCHUR_CANCELLATION_IDENTITY_PLUS_NUMERICALLY_CERTIFIED_FINITE_COHERENCE_TO_CANCELLATION_ATLAS`
编号事实终点：TPC-291；TPC-291 trigger：`true`
