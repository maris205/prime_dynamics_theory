...
更新时间：2026-08-10
状态：`BOLD_CHANNEL_V46 / TRANSITION_NATIVE_EULER_AND_AP_BDH_BRIDGE`
claim level：`EXACT_LOCAL_PROFILE_SPLIT_WITH_SOURCE_BACKED_LOCAL_CARRIER_AND_ONE_OPEN_AP_BDH_THEOREM`
编号事实终点：TPC-206；TPC-207 trigger：`false`

本文件把 TPC-1--206 看成 200 多个可审计研究节点，而不是 200 多篇彼此独立的
传统论文。它只做三件事：压缩旧地图、选一条主干、集中管理大胆假设。V46 的完整
