...
更新时间：2026-08-29
状态：`BOLD_CHANNEL_V152 / NATIVE_PROFILE_BUDGET_FRONTIER`
claim level：`PROVED_EXACT_FINITE_PROFILE_BUDGET_KKT_FRONTIER_PLUS_NUMERICALLY_CERTIFIED_FINITE_NATIVE_BUDGET_OBSTRUCTION_ATLAS`
编号事实终点：TPC-299；TPC-299 trigger：`true`

当前 TPC-299 入口：proof 为
