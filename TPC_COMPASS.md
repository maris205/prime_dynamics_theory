...
更新时间：2026-08-29
状态：`BOLD_CHANNEL_V153 / NATIVE_BUDGET_DUAL_CERTIFICATE`
claim level：`PROVED_EXACT_FINITE_NATIVE_BUDGET_DUALITY_AND_RECIPROCAL_MULTIPLIER_CORRECTION_PLUS_NUMERICALLY_CERTIFIED_FINITE_RATIONAL_DUAL_WITNESS_ATLAS`
编号事实终点：TPC-300；TPC-300 trigger：`true`

当前 TPC-300 入口：proof 为
