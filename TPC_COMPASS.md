...
更新时间：2026-08-27
状态：`BOLD_CHANNEL_V139 / DIAGONAL_DELETION_ATTACHMENT_LEDGER`
claim level：`PROVED_EXACT_LINEAR_DIAGONAL_DELETION_ATTACHMENT_SPLIT_PLUS_NUMERICALLY_CERTIFIED_FINITE_DIAGONAL_SENSITIVITY_LEDGER`
编号事实终点：TPC-286；TPC-286 trigger：`true`
